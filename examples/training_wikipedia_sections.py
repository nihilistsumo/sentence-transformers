...
train_batch_size = 16
triplet_reader = TripletReader('/media/sumanta/Seagate Backup Plus Drive/Dor_et_al_triples/by1train_discrim_triples',
                               s1_col_idx=1, s2_col_idx=2, s3_col_idx=3, delimiter=',', quoting=csv.QUOTE_MINIMAL, has_header=True)
